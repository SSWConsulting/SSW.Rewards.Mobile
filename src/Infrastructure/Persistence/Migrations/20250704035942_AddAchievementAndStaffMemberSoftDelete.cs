...
{
    /// <inheritdoc />
    public partial class AddAchievementAndStaffMemberSoftDelete : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                UPDATE Achievements
                SET DeletedUtc = '2025-07-01 00:00:00.0000000',
                LastModifiedUtc  = COALESCE(LastModifiedUtc, CreatedUtc)
                WHERE IsDeleted = 1;
            ");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_DeletedUtc",
                table: "StaffMembers",
                column: "DeletedUtc",
                filter: "[DeletedUtc] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Achievements_DeletedUtc",
                table: "Achievements",
                column: "DeletedUtc",
                filter: "[DeletedUtc] IS NULL");
        }
