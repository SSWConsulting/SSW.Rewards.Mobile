...
namespace SSW.Rewards.Persistence.Migrations
{
    ...
    [Migration("20260128043829_CreateTenantsAndTenantSettingsTables")]
    partial class CreateTenantsAndTenantSettingsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.Achievement", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Id"), new[] { "Value" });
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.Notification", b =>
                {
                    ...
                    b.Property<int>("NumberOfUsersSent")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfUsersTargeted")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.Reward", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Id"), new[] { "Cost" });
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.TenantSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("IdentityServerUrl")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.Property<string>("ProfileDeletionRecipient")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("QuizServiceUrl")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.Property<string>("StaffEmailDomain")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.UserReward", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId"), new[] { "RewardId" });
            ...
            modelBuilder.Entity("SSW.Rewards.Domain.Entities.TenantSettings", b =>
                {
                    b.HasOne("SSW.Rewards.Domain.Entities.Tenant", "Tenant")
                        .WithOne("Settings")
                        .HasForeignKey("SSW.Rewards.Domain.Entities.TenantSettings", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
