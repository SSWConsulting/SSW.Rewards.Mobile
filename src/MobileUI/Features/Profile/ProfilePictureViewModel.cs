...
public partial class ProfilePictureViewModel : BaseViewModel
{
    ...
    private async Task ChoosePhoto()
    {
        ...
        {
            await _alertService.DisplayAlert("No Camera", "We cannot seem to access the Camera", "OK");
        }
    }
    ...
    private async Task UsePhoto()
    {
        ...
        catch (Exception e)
        {
            ...
            {
                await _alertService.DisplayAlert("Oops...", "There seems to be a problem uploading your image. Please try again soon.", "OK");
            }
        }
    }
