...
export class AchievementClient extends BaseClient
  implements IAchievementClient {
  private http: {
  ...
  protected processAdminList(
    response: Response
  ): Promise<AchievementAdminListViewModel> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  add(achievementCode: string | null): Promise<AchievementViewModel> {
    ...
    if (achievementCode === undefined)
      ...
      url_ +=
        "achievementCode=" + encodeURIComponent("" + achievementCode) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  techQuiz(user: string | null): Promise<FileResponse> {
    ...
    else url_ += "user=" + encodeURIComponent("" + user) + "&";
    url_ = url_.replace(/[?&]$/, "");
...
export class LeaderboardClient extends BaseClient
...
export class RewardClient extends BaseClient implements IRewardClient {
  ...
  protected processAdminList(
    response: Response
  ): Promise<RewardAdminListViewModel> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  add(rewardCode: string | null): Promise<ClaimRewardResult> {
    ...
    else url_ += "rewardCode=" + encodeURIComponent("" + rewardCode) + "&";
    url_ = url_.replace(/[?&]$/, "");
...
export class UserClient extends BaseClient implements IUserClient {
  ...
  protected processAchievements(
    response: Response
  ): Promise<UserAchievementsViewModel> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class AchievementAdminListViewModel
  implements IAchievementAdminListViewModel {
  ...
  init(data?: any) {
    if (data) {
      this.viewModel = data["viewModel"]
        ? AchievementViewModel.fromJS(data["viewModel"])
        : <any>undefined;
...
export class RewardListViewModel implements IRewardListViewModel {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.rewards)) {
      data["rewards"] = [];
      for (let item of this.rewards) data["rewards"].push(item.toJSON());
    }
    return data;
  }
}
...
export class ClaimRewardResult implements IClaimRewardResult {
  ...
  init(data?: any) {
    if (data) {
      this.viewModel = data["viewModel"]
        ? RewardViewModel.fromJS(data["viewModel"])
        : <any>undefined;
      this.status = data["status"];
    }
  }
...
export class StaffListViewModel implements IStaffListViewModel {
  ...
  init(data?: any) {
    if (data) {
      if (Array.isArray(data["staff"])) {
        this.staff = [] as any;
        for (let item of data["staff"]) this.staff!.push(StaffDto.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.staff)) {
      data["staff"] = [];
      for (let item of this.staff) data["staff"].push(item.toJSON());
    }
    return data;
  }
}
  ...
  init(data?: any) {
    if (data) {
      ...
      if (Array.isArray(data["skills"])) {
        this.skills = [] as any;
        for (let item of data["skills"]) this.skills!.push(item);
      }
    }
  }
...
export class UserAchievementViewModel implements IUserAchievementViewModel {
  ...
  init(data?: any) {
    if (data) {
      ...
      this.awardedAt = data["awardedAt"]
        ? new Date(data["awardedAt"].toString())
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["awardedAt"] = this.awardedAt
      ? this.awardedAt.toISOString()
      : <any>undefined;
    return data;
  }
}
