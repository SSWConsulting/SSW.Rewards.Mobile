...
export class AchievementClient extends BaseClient
  ...
  ): Promise<AchievementAdminViewModel> {
...
export class PostAchievementResult implements IPostAchievementResult {
  ...
  init(_data?: any) {
    if (_data) {
      this.viewModel = _data["viewModel"]
        ? AchievementViewModel.fromJS(_data["viewModel"])
        : <any>undefined;
...
export class ClaimRewardResult implements IClaimRewardResult {
  ...
  init(_data?: any) {
    if (_data) {
      this.viewModel = _data["viewModel"]
        ? RewardViewModel.fromJS(_data["viewModel"])
        : <any>undefined;
      this.status = _data["status"];
    }
  }
...
export class UserAchievementViewModel implements IUserAchievementViewModel {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.awardedAt = _data["awardedAt"]
        ? new Date(_data["awardedAt"].toString())
        : <any>undefined;
    }
  }
